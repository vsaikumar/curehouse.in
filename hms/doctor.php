...
<div id="products_box">
											<tr>
												...
												<td><?php echo " <a href='book-appointment.php?book_a_slot=$pro_id'><button type='button' class='btn btn-default' style='float:center;' id='but'>Book a slot</button></a>";?><!-- / <?php echo
												 $row['appointmentTime'];?>
												</td>
